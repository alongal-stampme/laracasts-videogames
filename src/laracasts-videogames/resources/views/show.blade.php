    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-1">Final Fantasy IIV Remake</h2>
                ...
                <p class="mt-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus optio quod ratione temporibus vitae. Animi blanditiis commodi cum error esse maxime, modi, nesciunt omnis quo quos repudiandae, rerum tenetur! Autem id ipsam iste iusto maiores officia vel voluptatibus. Architecto aut consectetur error, iste laborum laudantium nemo obcaecati quisquam quo reiciendis!</p>
